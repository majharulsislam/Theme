		...
		<div class="<?php echo $has_sidebar ? 'layout-with-sidebar sidebar-' . esc_attr( $sidebar_position ) : ''; ?>">
			...
			<main id="main" class="site-main content-area" role="main">
				...
				while ( have_posts() ) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'nexblocks' ) . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'nexblocks' ) . '</span> <span class="nav-title">%title</span>',
						)
					);
			...
			<?php if ( $has_sidebar ) : ?>
				<aside class="widget-area" aria-label="<?php esc_attr_e( 'Post Sidebar', 'nexblocks' ); ?>">
